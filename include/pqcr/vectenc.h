...
struct vectcoder *pkpsig_vectcoder_new(vectelt *Mbuf, size_t nelts); /* clobbers Mbuf */
...
void pkpsig_vectcoder_encode(const struct vectcoder *vc, uint8_t *S, vectelt *Rbuf);
